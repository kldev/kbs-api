...
namespace KBS.Data.ConsoleApp
{
    public class Program
    {
        ...
        private static async Task<int> SeedAsync()
        {
            ...
            var salesId = Guid.Parse("bf7393ed-49ee-4a96-8701-03f4916d3820");
            var store = new BookStoreContext();
            ...
            store.Users.Add(new User
            {
                Id = salesId, Username = "salesman",
                Password = Encrypt("salesman123"),
            ...
            while (i++ < MAX_SALESMAN)
            {
                ...
                store.Users.Add(new User
                {
                    Role = UserRoleEnum.Salesman, Username = username, Password = Encrypt(username),
                    Id = Guid.NewGuid()
                });
            }
            ...
            foreach (var book in books)
            {
                ...
                {
                    Id = Guid.NewGuid(), Author = book.Author, Price = book.Price * 1.05M, Title = book.Title,

                    SoldDate = DateTime.Now, UserId = salesId
                });
            }
